                ...
                <div className="flex-1 flex flex-col justify-center">
                    ...
                    <motion.p
                     ...
                     className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-12 xl:px-0">
                        10 years ago, I began freelancing as a developr. Since then, I´ve donde remote work for agencies, consulted for startups, and collaborated on the digital products for business and consumer use.
                    </motion.p>
